...
export const config = {
  ...
  JWT_REFRESH_SECRET:
    process.env.JWT_REFRESH_SECRET ?? "ai-spaces-refresh-secret-change-in-production",
  AI_SPACES_DATA,
  ...
  AI_SPACES_AGENT_BASE_URL: normalizeOptionalUrl(
    process.env.AI_SPACES_AGENT_BASE_URL,
    "AI_SPACES_AGENT_BASE_URL",
  ),
