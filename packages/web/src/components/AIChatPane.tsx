...
import { type ConnectionStatus, useConnectionStatus } from "../contexts/ConnectionStatusContext";
  ...
  return (
    <div
      style={{
        ...
        width: "100%",
        background: "var(--t-agentSoft)",
        border: "1px solid var(--t-agent)",
        borderColor: "color-mix(in srgb, var(--t-agent) 30%, transparent)",
        padding: "12px 14px",
    ...
    >
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ children }) => (
            <h1
              style={{ fontSize: 15, fontWeight: 600, color: "var(--t-ink)", margin: "12px 0 4px" }}
            >
              {children}
            </h1>
          ),
          ...
          ul: ({ children }) => (
            <ul style={{ paddingLeft: 16, margin: "4px 0", fontSize: 13.5, color: "var(--t-ink)" }}>
              {children}
            </ul>
          ),
          ol: ({ children }) => (
            <ol style={{ paddingLeft: 16, margin: "4px 0", fontSize: 13.5, color: "var(--t-ink)" }}>
              {children}
            </ol>
          ),
          ...
          blockquote: ({ children }) => (
            <blockquote
              style={{
                borderLeft: "2px solid var(--t-hair)",
                paddingLeft: 12,
                margin: "4px 0",
                color: "var(--t-inkDim)",
                fontStyle: "italic",
...
export default function AIChatPane({ role = "viewer", spaceId, onClose }: AIChatPaneProps) {
  ...
  return (
    <aside
      ...
      style={{ background: "var(--t-bgRaised)", borderLeft: "1px solid var(--t-hair)" }}
    >
      <div
        style={{
          padding: "14px 18px",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span
            style={{ fontSize: 13, fontWeight: 700, letterSpacing: 0, color: "var(--t-agent)" }}
          >
            Chat
          </span>
        </div>
          ...
          >
            <textarea
              ...
              style={{
                ...
                height: 72,
                width: "100%",
                opacity: isStreaming || isDisconnected ? 0.6 : 1,
              }}
              placeholder={
                isDisconnected
                  ? "Reconnecting..."
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 500,
                  cursor:
                    !inputValue.trim() || isStreaming || isDisconnected ? "not-allowed" : "pointer",
                  opacity: !inputValue.trim() || isStreaming || isDisconnected ? 0.5 : 1,
                  fontFamily: "'Inter Tight', sans-serif",
                }}
              >
