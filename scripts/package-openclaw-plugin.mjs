...
try {
  ...
  execFileSync('tar', ['-czf', artifactPath, '-C', tempDir, 'openclaw-spaces'], { stdio: 'inherit' });
  ...
  writeFileSync(resolve(outDir, 'openclaw-spaces.meta.json'), `${JSON.stringify(metadata, null, 2)}\n`);
} finally {
