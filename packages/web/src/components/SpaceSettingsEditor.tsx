    ...
    <div className="flex flex-col h-full overflow-auto" style={{ background: "var(--t-bgRaised)" }}>
      <div className="flex-1 p-6 max-w-3xl mx-auto w-full">
        ...
        {visibleTabs.length > 1 && (
          <div className="flex gap-0 mb-6" style={{ borderBottom: "1px solid var(--t-hair)" }}>
            {visibleTabs.map((tab) => {
        ...
        {activeTab === "users" && (
          <section>
            {loadingMembers ? (
              ...
              <div style={{ fontSize: 13, color: "var(--t-accent)", padding: "12px 0" }}>
                {membersError}
              </div>
            ) : (
              <>
                ...
                >
                  <table className="w-full" style={{ fontSize: 14 }}>
                    ...
                    <tbody>
                      {members.map((member) => (
                        <tr key={member.userId} style={{ borderTop: "1px solid var(--t-hair)" }}>
